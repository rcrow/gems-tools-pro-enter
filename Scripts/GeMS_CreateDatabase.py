...
def main(thisDB, coordSystem, nCrossSections):
    ...
    if addConfs:
        ...
        cursor = arcpy.da.InsertCursor(thisDB + "/" + dbNameUserPrefix + "Glossary", ["Term", "Definition", "DefinitionSourceID"])
        ...
        cursor = arcpy.da.InsertCursor(thisDB + "/" + dbNameUserPrefix + "DataSources", ["DataSources_ID", "Source", "URL"])
        cursor.insertRow(
            (
                "FGDC-STD-013-2006",
